...
The expected value after 1 coin flip is $1050. Using the expected value formula, we can calculate the expected value of the account balance after 1 coin flip. The math is as follows: (.5x1500) + (.5x600) = $1050.
...
I am happy with the final outcome because there was a 704% return over 30 years. The beginning was very rough as it dropped to $540 in year 3. Although the growth was very volatile, we still came out to a net profit. However, this is understandable as the nature of the investment game was high-risk and high-reward. The returns were not very appealng up until year 45. The dips and peaks were volatile, but the end result being a net profit is a good outcome. I would be wary of playing this game because of the volatility and the fact that the returns were not very appealing up until year 45.
...
I am not happy with the overall results. Across 100 runs, the median balance was $206. Majority of the runs were well below the initial balance of $1000, suggesting a net loss from this game is highly probabile. Although the mean is $1782, this is heavily skewed by a few runs that had an extremely high return. Personally, I would not play this game as I am pretty risk-averse.
...
Based on the 100 simulations for the modified game strategy, there is a 0% chance the account balance will be greater than $10,000. On the other hand the original game strategy had a 4% chance of the ending balance being greater than $10,000. This is because of the original game's all in strategy, leading to a much more volatile and risky end result. Comparing the two column charts of the modified and orginal game strategy, you can immediately see the modified game strategy has a much more balanced distribution of final balances.
